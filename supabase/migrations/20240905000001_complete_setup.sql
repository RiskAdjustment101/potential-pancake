-- Complete database setup for FLL Mentor Copilot
-- This single migration creates everything needed with RLS enabled from the start
...
-- Create update timestamp function with proper security
...
-- Create RLS policies for season_weeks
